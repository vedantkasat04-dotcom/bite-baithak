...
export default function BoxScene() {
  ...
  return (
    <section ref={containerRef} id="story" className="relative w-full h-screen bg-[#1a0f0a] overflow-hidden flex flex-col items-center justify-center">
        ...
        <div className="relative w-full max-w-2xl mx-auto">
          ...
          <div className="flex justify-around items-end mt-4 px-8">
            <div className="flex flex-col items-center gap-1 opacity-80">
              <div className="w-10 h-10 rounded-full bg-[#2a1508]"/>
              <div className="w-12 h-16 bg-[#2a1508] rounded-t-full"/>
            </div>
            <div className="flex flex-col items-center gap-1">
              <div className="w-12 h-12 rounded-full bg-[#1f0f05]"/>
              <div className="w-14 h-20 bg-[#1f0f05] rounded-t-full"/>
            </div>
            <div className="flex flex-col items-center gap-1">
              <div className="w-11 h-11 rounded-full bg-[#3a1f10]"/>
              <div className="w-16 h-20 bg-[#8b3a4a] rounded-t-full"/>
            </div>
            <div className="flex flex-col items-center gap-1 opacity-75">
              <div className="w-8 h-8 rounded-full bg-[#3a1f10]"/>
              <div className="w-10 h-14 bg-[#3a1f10] rounded-t-full"/>
            </div>
          </div>
        </div>
      </div>
      ...
      <p ref={captionRef} className="absolute bottom-16 left-1/2 -translate-x-1/2 text-[#d4af6a] font-serif italic text-lg text-center">
        A box arrives.
      </p>
